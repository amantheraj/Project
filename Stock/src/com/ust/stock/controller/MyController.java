...
import com.ust.stock.service.MyService;
...
public class MyController {
	...
	return new ModelAndView("searchproduct");
				  ...
				  return new ModelAndView("login","msg3","<h3>Login First</h3>");
			  }
	}
	...
	public ModelAndView registrationData(@ModelAttribute UserDTO rdto){
		...
		System.out.println("inside controller");
			...
			if(b){
	return new ModelAndView("login","dto","<h3>Registration Successfull</h3>");
			}else{
				return new ModelAndView("registration","dto","<h3>User Already Registered</h3>");
			}
	}
		...
		System.out.println("logout");
		 if(h.getAttribute("email")!=null) {
			...
			h.setAttribute("email",null);
			 return new ModelAndView("login","msg2","<h3>Logout Successful</h3>");
			
		}else{
			return new ModelAndView("login","msg2","<h3>Login First</h3>");
		}
	...
	public ModelAndView addData(@ModelAttribute ProductDTO dto){
		...
		if(b){
			return new ModelAndView("Home","dto1","<h3>Product Added</h3> ");
					}else{
